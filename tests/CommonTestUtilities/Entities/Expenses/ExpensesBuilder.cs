...
namespace CommonTestUtilities.Entities.Expenses
{
    public class ExpensesBuilder
    {
        ...
        public static Expense Build(User user)
        {
            return new Faker<Expense>()
                ...
                .RuleFor(u => u.Amount, faker => faker.Random.Decimal(min: 1, max: 100))
                .RuleFor(u => u.PaymentType, faker => faker.PickRandom<CashFlow.Domain.Enums.PaymentType>())
